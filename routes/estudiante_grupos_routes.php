...
Route::group(['prefix' => 'estudiantes_grupos', 'middleware' => 'auth_docentes'], function () {
    ...
    Route::put('/edit/{id}', [EstudianteGrupoController::class, 'update'])->name('estudiantes_grupos.update');

    Route::get('/delete/{id}', [EstudianteGrupoController::class, 'delete'])->name('estudiantes_grupos.delete');
    Route::delete('/delete/{id}', [EstudianteGrupoController::class, 'destroy'])->name('estudiantes_grupos.destroy');
});
