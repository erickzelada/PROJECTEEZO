            ...
            <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                        ...
                        @if (auth()->check() )
                        <li><a href={{route('docentes.logout')}} class="dropdown-item">Cerrar Sesion</a></li>
                        @else
                        <li><a class="dropdown-item" href="{{ route('docentes.showLoginForm')}}">Iniciar sesión Docente</a></li>
                        <li><a class="dropdown-item" href="{{ route('asistencias.marcar')}}">Marcar Asistencia Estudiante</a></li>
                        @endif
                    </ul>
                </li>
            </ul>
